  ...
  return (
    <>
     ...
     <div className="absolute top-[5%] left-[50%] z-20 opacity-90 aspect-square w-[300px] h-[300px] p-0 rounded-full overflow-hidden outline-0 outline-green-600">
        <img src={'src/assets/circuit.svg'} width={300} height={300} alt="Small Ellipse" style={{ objectFit: 'cover', height: '300px', width: '300px'}} className="  " />
    </div>
      {/* Solid SVG Ellipse */}
    <div className="absolute top-[5%] left-[43%] z-10 ">
      <img src={'src/assets/small-ellipse.svg'} loading="lazy" width={282} height={282} alt="Small Ellipse" />
    </div>
    {/* Solid Larger Ellipse */}
    <div className="absolute top-[10%] left-[80%] z-10 ">
      <img src={'src/assets/large_ellipse.svg'} loading="lazy" width={500} height={500} alt="Large Ellipse" />
    </div>
    {/* Transparent Overlay */}
