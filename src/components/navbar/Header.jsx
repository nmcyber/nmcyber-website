  ...
  return (
    ...
    >
      <div className=" relative flex justify-between items-center px-5 lg:px-7 xl:px-9 max-lg:py-4">
        ...
        >
          <div
            className={`relative z-50 flex flex-col  mb-14 items-center justify-center h-full lg:h-auto m-auto lg:flex-row  ${
              openNavigation ? " -top-20" : ""
            } `}
          >
            {navigation.map((item) => (
              <a
