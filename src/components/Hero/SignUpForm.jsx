...
const SignUpForm = () => {
  ...
  return (
    <motion.div
      ...
      className=" relative z-30 bg-[rgba(0, 21, 48, 0.51)] bg-opacity-10 p-8 rounded-2xl border border-[#61c9f2] backdrop-filter isolate backdrop-blur-[80px] max-w-lg w-full outline outline-0 outline-red-400"
    >
                ...
                <FormItem>
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      className="bg-[#456377] bg-opacity-25 focus:bg-opacity-25 text-white placeholder-white placeholder-opacity-60 border-[#126b8e] rounded-full py-8 px-8"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
