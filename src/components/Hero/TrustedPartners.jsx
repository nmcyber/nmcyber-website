...
const TrustedPartners = () => {
  return (
    ...
    >
      ...
      {/* <div className="flex justify-center items-center space-x-8 py-0 outline outline-lime-500">
        {[1, 2, 3, 4, 5].map((star) => (
      ...
      <div className=" ~py-4/6 md:~px-2/28 flex justify-center items-center ~space-x-12/20 outline-0 outline-orange-500">
